...
You can build your deck on the [Deck Builder](/decks) page.
...
To import this deck, copy this code into the <Link href="/deck-builder">Deck
Builder</Link>:

<div className="join mx-auto flex w-64 items-center">
  <input
    type="text"
    className="input input-bordered join-item"
    value={'T1-T1-F1-F2-F2-F3-F3-DD-I2&4-I3&6'}
